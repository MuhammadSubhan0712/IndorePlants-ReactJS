  ...
  return (
    <div id="about" className="bg-green-950 py-16 relative">
      ...
      <div className="absolute top-0 right-0 hidden md:block">
        <img className="h-64 w-64" src="/leaf-3.png" alt="decoration" />
      </div>
      {/* Heading */}
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 mb-16">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <p className="text-white text-lg">
              ...
              garden, whether you&#8217;re a beginner or an experienced
              gardener. With our expert tips, high-quality plants, and
              eco-friendly products, you can grow your own green oasis at home.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="w-full md:w-1/2 space-y-6">
            ...
            <p className="text-white text-lg">
              ...
              advice. Together, let&#8217;s make the world a greener place, one
              plant at a time.
            </p>
          </div>
